...
@Tag(name = "Delivery boy App", description = "APIs for the Delivery Boy Mobile App")
@PreAuthorize("hasRole('DELIVERY_BOY')")
public class DeliveryBoyController {

    private final DeliveryBoyAppService deliveryAppService;
    ...
    @Operation(summary = "Mark an order as delivered and free up the delivery boy")
